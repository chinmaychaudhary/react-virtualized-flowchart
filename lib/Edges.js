...
var Edges =
  ...
  (function(_PureComponent) {
      ...
      (0, _defineProperty2.default)(
        ...
        function() {
          ...
          removedEdges.forEach(function(edge) {
            ...
            (0,
            _forEach2.default)(edge.customOverlays, function(customOverlay) {
              _this.deleteCustomOverlay(edge, customOverlay);
            });
      ...
      (0, _defineProperty2.default)(
        ...
        function() {
          ...
          addedEdges.forEach(function(edge) {
            ...
            (0,
            _forEach2.default)(edge.customOverlays, function(customOverlay) {
              _this.renderCustomOverlay(edge, customOverlay);
            });
          });
        }
      );
    ...
    (0, _createClass2.default)(Edges, [
      ...
      {
        key: "renderCustomOverlay",
        value: function renderCustomOverlay(edge, overlay) {
          var overlayId = (0, _helper.getOverlayId)(edge, overlay);
      ...
      {
        key: "deleteCustomOverlay",
        value: function deleteCustomOverlay(edge, overlay) {
          var overlayId = (0, _helper.getOverlayId)(edge, overlay);
