...
var _jsxFileName = "/Users/chicho17/react-learn/react-virtualized-flowchart/src/Edges.js";
...
function (_PureComponent) {
  ...
  function Edges() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(Edges)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "addConnectionsAndEndpoints", function () {
      ...
      addedEdges.forEach(function (edge) {
        ...
        var sourceEndpoint = _this.plumbInstance.addEndpoint(sourceId, _objectSpread({}, edge.sourceEndpointStyles || _this.props.sourceEndpointStyles, {}, edge.sourceEndpointOptions || _this.props.sourceEndpointOptions, {
          isSource: true
        })),
            targetEndpoint = _this.plumbInstance.addEndpoint(targetId, _objectSpread({}, edge.targetEndpointStyles || _this.props.targetEndpointStyles, {}, edge.targetEndpointOptions || _this.props.targetEndpointOptions, {
          isTarget: true
        }));

        _this.plumbConnections[edge.id] = _this.plumbInstance.connect(_objectSpread({}, edge.styles || _this.props.edgeStyles, {}, edge.options || _this.props.edgeOptions, {
  ...
  (0, _createClass2.default)(Edges, [{
    ...
    value: function makeVerticesDraggable(vertices) {
      ...
      vertices.forEach(function (vertex) {
        _this4.plumbInstance.draggable(vertex.id, _objectSpread({}, _this4.props.draggableOptions, {
          stop: _this4.handleStop
        }));

        if (!_this4.plumbInstance.getElement(vertex.id).classList.contains("jtk-droppable")) {
          _this4.plumbInstance.droppable(vertex.id, _objectSpread({}, _this4.props.droppableOptions, {
