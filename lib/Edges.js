...
var _jsxFileName = "/Users/chicho/repos/react-virtualized-flowchart/src/Edges.js";
...
var Edges = /*#__PURE__*/function (_PureComponent) {
  ...
  function Edges() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleStop", function (dragEndEvent) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleDrop", function (dropEndEvent) {
      _this.props.onAction({
        type: "ITEM_DROPPED",
        payload: {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "removeConnectionsAndEndpoints", function () {
      var removedEdges = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "addConnectionsAndEndpoints", function () {
      var addedEdges = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
      addedEdges.forEach(function (edge) {
        var sourceId = edge.sourceId,
            targetId = edge.targetId;

        var sourceEndpoint = _this.plumbInstance.addEndpoint(sourceId, _objectSpread(_objectSpread(_objectSpread({}, edge.sourceEndpointStyles || _this.props.sourceEndpointStyles), edge.sourceEndpointOptions || _this.props.sourceEndpointOptions), {}, {
          isSource: true
        })),
            targetEndpoint = _this.plumbInstance.addEndpoint(targetId, _objectSpread(_objectSpread(_objectSpread({}, edge.targetEndpointStyles || _this.props.targetEndpointStyles), edge.targetEndpointOptions || _this.props.targetEndpointOptions), {}, {
          isTarget: true
        }));

        _this.plumbConnections[edge.id] = _this.plumbInstance.connect(_objectSpread(_objectSpread(_objectSpread({}, edge.styles || _this.props.edgeStyles), edge.options || _this.props.edgeOptions), {}, {
  ...
  (0, _createClass2.default)(Edges, [{
    ...
    value: function componentDidMount() {
      ...
      _jsplumb.jsPlumb.ready(function () {
        _this2.plumbInstance = _jsplumb.jsPlumb.getInstance(_this2.props.containerEl);
    ...
    value: function componentDidUpdate(prevProps) {
      if (prevProps.vertices !== this.props.vertices) {
        this.updateVertices((0, _helper.getAddedOrRemovedItems)(prevProps.vertices, this.props.vertices));
      }

      if (prevProps.edges !== this.props.edges) {
        this.updateConnections((0, _helper.getAddedOrRemovedItems)(prevProps.edges, this.props.edges));
      }
    }
  }, {
    ...
    value: function makeVerticesDraggable(vertices) {
      ...
      vertices.forEach(function (vertex) {
        _this4.plumbInstance.draggable(vertex.id, _objectSpread(_objectSpread({}, _this4.props.draggableOptions), {}, {
          stop: _this4.handleStop
        }));

        if (!_this4.plumbInstance.getElement(vertex.id).classList.contains("jtk-droppable")) {
          _this4.plumbInstance.droppable(vertex.id, _objectSpread(_objectSpread({}, _this4.props.droppableOptions), {}, {
    ...
    value: function updateVertices(_ref2) {
      ...
      if (this.props.areVerticesDraggable) {
        ...
        itemsAdded.map(function (vertex) {
          _this5.plumbInstance.manage(vertex.id, _this5.plumbInstance.getElement(vertex.id));
        });
      }
      /*
