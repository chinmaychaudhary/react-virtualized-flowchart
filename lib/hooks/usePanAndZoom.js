...
var usePanAndZoom = function usePanAndZoom(_ref) {
  ...
  var incrementZoom = (0, _react.useCallback)(
    function() {
  ...
  var decrementZoom = (0, _react.useCallback)(
    function() {
  ...
  var resetZoom = (0, _react.useCallback)(
    function() {
      setZoom(_constants.DEFAULT_ZOOM, _constants.CENTER);
    },
    [setZoom]
  );
  var combinedRef = (0, _react.useCallback)(
    function(el) {
      setContainer(el);
  ...
  (0, _react.useEffect)(
    function() {
      ...
      var _getTranslate3DCoordi = (0, _helper.getTranslate3DCoordinates)(
          clientWidth,
          clientHeight,
          pan,
          zoom,
      ...
      diagramContainerRef.current.style.transform = "translate3D("
        ...
        .concat(translateY, "px, 0) scale(")
        .concat(zoom, ")");

      var _getContainerScroll = (0, _helper.getContainerScroll)(
          scroll.left,
          scroll.top,
          zoom,
