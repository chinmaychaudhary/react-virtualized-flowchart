...
var useIntervalTree = function useIntervalTree(
  edges,
  verticesMap,
  isXIntervalTree
) {
  ...
  var xIntervalTree = xIntervalTreeRef.current;
  var xIntervalTreeNodes = xIntervalTreeNodesRef.current;
  var yIntervalTree = yIntervalTreeRef.current;
  var yIntervalTreeNodes = yIntervalTreeNodesRef.current;
  ...
  var updateEdges = function updateEdges(
    ...
    var xIntervalIdToIndex = new Map(
      xIntervalTree.intervals.map(function(_ref3, index) {
    ...
    var yIntervalIdToIndex = new Map(
      yIntervalTree.intervals.map(function(_ref5, index) {
