...
var _intervalTree = _interopRequireDefault(
  require("@flatten-js/interval-tree")
);
    ...
    function Diagram(props) {
      ...
      (0, _defineProperty2.default)(
        ...
        function(edge, verticesMap) {
          ...
          if (
            (_this$treeNodeById$ed = _this.treeNodeById[edgeId]) !== null &&
            _this$treeNodeById$ed !== void 0 &&
            _this$treeNodeById$ed.xInterval
          ) {
            return;
          }
          ...
          _this.treeNodeById[edgeId] = _objectSpread(
            {},
            _this.treeNodeById[edgeId],
            {
              xInterval: interval,
              edge: edge
            }
      ...
      (0, _defineProperty2.default)(
        ...
        function(edge, verticesMap) {
          ...
          if (
            (_this$treeNodeById$ed2 = _this.treeNodeById[edgeId]) !== null &&
            _this$treeNodeById$ed2 !== void 0 &&
            _this$treeNodeById$ed2.yInterval
          ) {
            return;
          }
    ...
    (0, _createClass2.default)(Diagram, [
      ...
      },
      {
        ...
        value: function updateIntervalTrees(_ref4, verticesToEdgesMap) {
          ...
          itemsRemoved.forEach(function(vertex) {
            ...
            edges.forEach(function(edge) {
              (0,
              _helper.removeNode)(_this6.xIntervalTree, _this6.yIntervalTree, _this6.treeNodeById, edge.id);
            });
          });
      ...
      },
      {
        ...
        value: function updateEdges(_ref5, verticesMap) {
          ...
          itemsRemoved.forEach(function(edge) {
            ...
            (0,
            _helper.removeNode)(_this7.xIntervalTree, _this7.yIntervalTree, _this7.treeNodeById, edgeId);
          });
      ...
      },
      {
        ...
        value: function getVisibleEdges(zoom) {
          ...
          var _ref6 = this.containerRef.current
