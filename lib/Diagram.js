...
var Diagram = function Diagram(props) {
  ...
  var _useMemo = (0, React.useMemo)(
      function() {
        return getExtremeXAndY();
      },
      [getExtremeXAndY]
    ),
    _useMemo2 = (0, _slicedToArray2.default)(_useMemo, 2),
    extremeX = _useMemo2[0],
    extremeY = _useMemo2[1];

  var renderChildren = (0, React.useCallback)(
    function() {
      var zoom =
        arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      var verticesMap = getVisibleVertices(zoom);
  ...
  if (props.enableZoom) {
    return React.createElement(
      ...
      function(_ref3) {
        var zoom = _ref3.zoom;
        return React.createElement(React.Fragment, null, renderChildren(zoom));
      }
    );
  }
