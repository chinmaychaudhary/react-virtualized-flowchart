...
var _jsxFileName =
  "/Users/chicho17/react-learn/react-virtualized-flowchart/src/Diagram.js";
var MARGIN = 100;
      ...
      },
      {
        ...
        value: function updateIntervalTrees(_ref6, verticesToEdgesMap) {
          ...
          itemsRemoved.forEach(function(vertex) {
            ...
            edges.forEach(function(edge) {
              removeNode(
                _this5.xIntervalTree,
                _this5.xIntervalTreeNodes,
                edge.id
              );
              removeNode(
                _this5.yIntervalTree,
                _this5.yIntervalTreeNodes,
                edge.id
              );
            });
          });
      ...
      },
      {
        ...
        value: function updateEdges(_ref7, verticesMap) {
          ...
          var xIntervalIdToIndex = new Map(
            this.xIntervalTree.intervals.map(function(_ref8, index) {
          ...
          var yIntervalIdToIndex = new Map(
            this.yIntervalTree.intervals.map(function(_ref10, index) {
